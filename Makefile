# This Makefile is for the CyberSource::SOAP::Checkout extension to perl.
#
...
#     ABSTRACT => q[A Modern Perl interface to CyberSource's SOAP API.]
#     AUTHOR => q[Amiri Barksdale <amiri@metalabel.com>]
#     BUILD_REQUIRES => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.42] }
#     DIR => []
#     DISTNAME => q[CyberSource-SOAP-Checkout]
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.008001]
#     NAME => q[CyberSource::SOAP::Checkout]
#     NO_META => q[1]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = CyberSource::SOAP::Checkout
NAME_SYM = CyberSource_SOAP_Checkout
VERSION = 0.01
...
INSTALLARCHLIB = /home/amiri/local/lib/perl5/5.10.1/x86_64-linux-thread-multi
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /home/amiri/local/lib/perl5/site_perl/5.10.1/x86_64-linux-thread-multi
...
INSTALLMAN1DIR = /home/amiri/local/share/man/man1
DESTINSTALLMAN1DIR = $(DESTDIR)$(INSTALLMAN1DIR)
INSTALLSITEMAN1DIR = /home/amiri/local/share/man/man1
DESTINSTALLSITEMAN1DIR = $(DESTDIR)$(INSTALLSITEMAN1DIR)
INSTALLVENDORMAN1DIR = 
DESTINSTALLVENDORMAN1DIR = $(DESTDIR)$(INSTALLVENDORMAN1DIR)
INSTALLMAN3DIR = /home/amiri/local/share/man/man3
DESTINSTALLMAN3DIR = $(DESTDIR)$(INSTALLMAN3DIR)
INSTALLSITEMAN3DIR = /home/amiri/local/share/man/man3
...
MAKE = make
FULLEXT = CyberSource/SOAP/Checkout
BASEEXT = Checkout
PARENT_NAME = CyberSource::SOAP
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CyberSource/SOAP/Checkout.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/CyberSource/SOAP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CyberSource/SOAP
...
TO_INST_PM = lib/CyberSource/SOAP/Checkout.pm \
	lib/CyberSource/SOAP/Checkout/Response.pm

PM_TO_BLIB = lib/CyberSource/SOAP/Checkout.pm \
	blib/lib/CyberSource/SOAP/Checkout.pm \
	lib/CyberSource/SOAP/Checkout/Response.pm \
	blib/lib/CyberSource/SOAP/Checkout/Response.pm
...
DISTNAME = CyberSource-SOAP-Checkout
DISTVNAME = CyberSource-SOAP-Checkout-0.01
...
manifypods : pure_all  \
	lib/CyberSource/SOAP/Checkout.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CyberSource/SOAP/Checkout.pm $(INST_MAN3DIR)/CyberSource::SOAP::Checkout.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A Modern Perl interface to CyberSource'\''s SOAP API.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Amiri Barksdale &lt;amiri@metalabel.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CyberSource/SOAP/Checkout.pm blib/lib/CyberSource/SOAP/Checkout.pm \
	  lib/CyberSource/SOAP/Checkout/Response.pm blib/lib/CyberSource/SOAP/Checkout/Response.pm 
